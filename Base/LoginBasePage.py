...
from tkinter import *
import kfxt.kfxtweblogin as kfxtguanwanglogin
...
class initfacepage():
    def __init__(self, master):
        ...
        Addbtn = tk.Button(self.Addsubface, text='快服网添加子账号',
                command=self.add)
        Addbtn.grid(row=0,column=0,pady=15,sticky=E,padx=10);
        #重置账号密码的按钮
        ...
        Forgetpwdbtn.grid(row=1, column=0,pady=15,sticky=E,padx=10)
        #快服网登录的按钮
    ...
    #快服网我的快服修改个人密码
        ...
        Moditypwdbtn.grid(row=2, column=0,pady=15,sticky=E,padx=10)
    # 快服网工号管理重置密码
    ...
    # 客服系统登录接口
        ...
        kfxtloginbtn.grid(row=3, column=0,pady = 15,sticky=E,padx=10);
    # 客服系统工号管理密码重置
    ...
    # 客服系统官网登录
        kfxtwebbtn = tk.Button(self.Addsubface,text="客服系统官网登录接口",
                               command = self.kfxtweblogin)
        kfxtwebbtn.grid(row=4,column=0,sticky = E,pady = 15,padx=10);
    # 掌上客服登录
        mobilekfbtn = tk.Button(self.Addsubface,text="掌上客服登录接口",
                               command = self.mobilekflogin)
        mobilekfbtn.grid(row=4,column=1,sticky = W);
    # 添加账号的点击事件
    def add(self):
...
#     客服系统登录的点击事件
    ...
    def kfxtghglresetpwd(self):
        ...
        print('客服系统工号管理密码重置')
#     客服系统官网登录接口
    def kfxtweblogin(self):
        self.Addsubface.destroy();
        kfxtguanwanglogin.kfxtWebLogin(self.master);
#     掌上客服登录接口
    def mobilekflogin(self):
        print('mobile')
